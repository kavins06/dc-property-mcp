...
- [ ] Register the three MAR sources and normalize deterministic address,
...
- [ ] Add migration 0031 and the additive parcel-resolution contract.
...
- [ ] Expose parcel pagination through the existing MCP resolver.
